...
function App() {
  ...
  const messages = [
    "Hello baby, It's your day to shine!",
    "I’ve set up something super vibrant just for you in your favourite color...",
              ...
              <AnimatePresence mode="wait">
                {!showSongMessage && !showFinalMessage ? (
                  ...
                  >
                    ...
                    >
                      Let's get this party started Priyanshi!
                    </motion.p>
                  </motion.div>
                )}
              </AnimatePresence>
