  ...
  return (
    ...
    >
      <div className="text-3xl mb-8 text-pink-600 font-semibold text-center">
        {!isCut ? (
          <span>✨ Light the candles by clicking on them and drag down the knife to cut the cake! ✨</span>
        ) : (
          <span>🎉 Happy Birthday Priyanshiiii! 🎉</span>
        )}
      </div>
      ...
      {isCut && (
        ...
        >
          Stop right here and make a wish!⭐️
        </motion.div>
      )}
    </motion.div>
  );
