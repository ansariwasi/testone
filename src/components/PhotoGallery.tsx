...
const photos: Photo[] = [
  {
    url: Pic1,
    caption:
      "Happy Birthday to the one who knows how I am and still made me smile. I hope you have another year of laughter, good health, and beautiful memories.",
  },
  {
    url: Pic2,
    caption:
      "To my princess, my therapist, and my biggest cheerleader—happy birthday, My Queen! The world shines brighter with you in it. 👑✨",
  },
  {
    url: Pic3,
    caption:
      "Cheers to you on your special day! Having you felt like an unfair advantage and I love you for that🥂💖",
  },
];
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="relative mx-auto">
            ...
            <motion.button
              ...
              onClick={onComplete}
            >
              I wrote something special for you, Priyanshi❤️
            </motion.button>
          </div>
        </div>
      </div>
